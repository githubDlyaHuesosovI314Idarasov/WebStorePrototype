...
- Создайте проект Angular с помощью ng: `ng new webstoreapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Создание файла проекта (`webstoreapp.client.esproj`).
